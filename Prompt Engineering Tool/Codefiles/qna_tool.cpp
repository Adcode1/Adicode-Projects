...
void QNA_tool::query(string question, string filename){
    ...
    cout<<query_llm(filename,head,5, "Your Open-Api-key ", " Answer the following question on the basis of the text: " + question);
